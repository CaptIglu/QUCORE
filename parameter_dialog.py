...
class ParameterDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.spin_stall.setRange(0.0, 100.0)
        ...
        self.spin_gps_inacc.setRange(0.0, 50.0)
        ...
        self.spin_pos_err.setRange(0.0, 50.0)
        ...
        self.spin_map_err.setRange(0.0, 50.0)
        ...
        self.spin_t_rz.setRange(0.1, 10.0)
        ...
        self.spin_alt_gps.setRange(0.0, 50.0)
        ...
        self.spin_alt_baro.setRange(0.0, 50.0)
        ...
        self.spin_add_horiz.setRange(0.0, 500.0)
        self.spin_add_horiz.setValue(self.params.get("additionalErrorLateral", 0.0))
        self.spin_add_horiz.setSuffix(" m")
        self.spin_add_horiz.setSingleStep(1.0)
        self.spin_add_horiz.setDecimals(1)
        ...
        self.spin_add_vert.setRange(0.0, 500.0)
        self.spin_add_vert.setValue(self.params.get("additionalErrorVertical", 0.0))
        self.spin_add_vert.setSuffix(" m")
        self.spin_add_vert.setSingleStep(1.0)
        self.spin_add_vert.setDecimals(1)
        ...
        self.spin_roll_angle.setRange(5.0, 80.0)
        ...
        self.spin_pitch_angle.setRange(5.0, 80.0)
        ...
        self.spin_para_lat.setRange(0.1, 20.0)
        ...
        self.spin_para_vert.setRange(0.1, 20.0)
        ...
        self.spin_glide.setRange(1.0, 100.0)
        ...
        self.spin_para_grb.setRange(0.1, 20.0)
        ...
        self.spin_wind.setRange(0.0, 50.0)
        ...
        self.spin_descent.setRange(0.1, 50.0)
